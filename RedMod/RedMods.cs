...
namespace RogueLibsCore.Examples
{
    ...
    public class RedMods : BaseUnityPlugin
    {
        public const string pluginGuid = "redmod.streetsofrogue.saitama";
        public const string pluginName = "RealSaitama";
        ...
        public void Awake()
        {
            ...
            if(setup == false) {
                ...
                CustomItem punchItem = RogueLibs.SetItem("saitamaPunch", punchSprite,
                    ...
                    new CustomNameInfo("Just one punch is enoght"),
                    item =>
                    {
